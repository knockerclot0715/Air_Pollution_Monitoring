...
Database_Connection.query('SELECT * FROM Air_Pollution_Reading_Record WHERE Time_Of_Record > '+Current_Time+' AND Time_Of_Record <= '+Previous_Time+'', function(error, results) {
  if (error) {
