...
var Current_Time = "2018-03-25 05:00:20";
console.log("Previous Time:", Previous_Time);

Database_Connection.connect();
Database_Connection.query('SELECT * FROM Air_Pollution_Project.Air_Pollution_Reading_Record WHERE Time_Of_Record > '+Current_Time+' AND Time_Of_Record <= '+Previous_Time+'', function(error, results) {
  if (error) {
